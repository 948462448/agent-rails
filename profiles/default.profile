...
AGENT_RAILS_TOKENIZER_PATH="${AGENT_RAILS_TOKENIZER_PATH:-}"
AGENT_RAILS_TIKTOKEN_ENCODING="${AGENT_RAILS_TIKTOKEN_ENCODING:-cl100k_base}"
AGENT_RAILS_OPENCODE_CONTEXT_PERCENT="${AGENT_RAILS_OPENCODE_CONTEXT_PERCENT:-25}"
AGENT_RAILS_OPENCODE_MAX_PACK_TOKENS="${AGENT_RAILS_OPENCODE_MAX_PACK_TOKENS:-60000}"
AGENT_RAILS_OPENCODE_MIN_PACK_TOKENS="${AGENT_RAILS_OPENCODE_MIN_PACK_TOKENS:-512}"
AGENT_RAILS_OPENCODE_RESERVE_PERCENT="${AGENT_RAILS_OPENCODE_RESERVE_PERCENT:-5}"
AGENT_RAILS_OPENCODE_RESERVE_TOKENS="${AGENT_RAILS_OPENCODE_RESERVE_TOKENS:-2048}"
AGENT_RAILS_OPENCODE_HOOK_TIMEOUT_MS="${AGENT_RAILS_OPENCODE_HOOK_TIMEOUT_MS:-30000}"
